...
<tbody>
<?php $k=0;
for ($i=0; $i <count($payment_other) ; $i++) 
{ 
foreach ($payment_other[$i] as $item):
$k++;
?>
		<tr class="warning">
		<td><?=$k?></td>
